...
const NPCS: NPC[] = [
  {
    id: 'vigilante', name: 'el vigilante', x: 64, y: 84, w: 28, h: 50,
    feet: { x: 78, y: 134 }, walkTo: { x: 52, y: 138 }, facing: 'right', color: [220, 200, 170],
    look: 'El vigilante de la urbanización. Brazos cruzados, cadena de oro y cara de pocos amigos.',
    ...
    accepts: {
      nota: {
        ...
        card: [
          ...
          '',
          'CONTINUARÁ... Episodio 3: Dentro del Godot',
        ],
      },
    },
  },
