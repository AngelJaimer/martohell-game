...
const HOTSPOTS: Hotspot[] = [
  {
    ...
    card: [
      'MARTOHELL: FIN',
      '',
      'Friegas la pota y el portal se cierra de golpe.',
      'Los espíritus se despiden y se van en paz.',
      '',
      'Amanece en el Pont del Diable. Allá arriba,',
      'el Petit Pulmó te saluda desde una nube:',
      '"No se está tan mal aquí, noi. Buena gente.',
      'Te espero, sin prisa, con birra fresca."',
      '',
      'Has salvado Martohell. ¡FIN!',
    ],
  },
